...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CRaj::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(CRaj::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CRaj::Instance()->themeParentUrl . "/{$url}");
}
